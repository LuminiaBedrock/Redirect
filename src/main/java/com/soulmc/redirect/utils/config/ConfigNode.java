package com.soulmc.redirect.utils.config;

import com.soulmc.redirect.utils.StringUtils;
...
public class ConfigNode {
    ...
    public Integer getInt(Integer defaultValue) {
        return StringUtils.parseInteger(String.valueOf(getValue(defaultValue)));
    }
    ...
    public Long getLong(Long defaultValue) {
        return StringUtils.parseLong(String.valueOf(getValue(defaultValue)));
    }
    ...
    public Double getDouble(Double defaultValue) {
        return StringUtils.parseDouble(String.valueOf(getValue(defaultValue)));
    }
    ...
    public Float getFloat(Float defaultValue) {
        return StringUtils.parseFloat(String.valueOf(getValue(defaultValue)));
    }
